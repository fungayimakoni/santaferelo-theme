...
get_header();
	echo '<section class="main-layout inner-page-layout">';
		echo '<div class="container-fluid default-container">';
			echo '<div class="row">';
				if (get_field('banner', '4835')):
					$banner = get_field('banner', '4835');
				...
				echo '<div class="container text-test">';
					echo get_post_field('post_content', '4835');
				echo '</div>';
				if( have_rows('content_blocks' , '4835') ):
					echo '<div class="content-block">';
					    while ( have_rows('content_blocks' , '4835') ) : the_row();
				...
				$author = get_field('authors_block', '4835');
				if( $author ):
					echo '<div class="row">';
						echo '<div class="author-content">';
							echo '<div class="container">';
								echo '<h2>Authors and contributors</h2>';
								echo '<p style="margin-bottom: 48px;">In addition to sharing the results from the Global Mobility Survey 2019, this report also provides critical analysis and insights from 17 industry leaders.</p>';
				...
				$author = get_field('authors_block_external', '4835');
				if( $author ):
					echo '<div class="row">';
						echo '<div class="author-content">';
							echo '<div class="container">';
								echo '<h3>External contributors</h3>';
									foreach($author as $item):
