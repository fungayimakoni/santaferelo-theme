<?php get_header();
	echo '<section class="main-layout inner-page-layout">';
					...
					if ( $banner['banner_image'] ):
						echo '<div class="page-banner">';
							echo '<div class="banner-wrapper">';
								...
								echo wp_get_attachment_image( $banner['banner_image']['id'], 'full', false, array( 'class' => 'banner-image-full','alt' => $banner['banner_image']['alt'],'style' => 'display:none;' ) );
								echo '</div>';
							echo '</div>';
		...
		echo '</div>';
	echo '</section>';
if( is_page( array( 8451, 6627, 4112, 4113, 3813, 1968, 3115, 5447, 5448, 7502) ) ):
	get_footer('form');
else:
	get_footer();
endif; ?> 