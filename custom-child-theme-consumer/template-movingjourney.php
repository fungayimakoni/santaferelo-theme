<?php 
/*
Template Name:Moving Journey template
*/
get_header();
	echo '<section class="main-layout inner-page-layout testjourney">';
			...
			echo '<div class="row">';
				...
				if( have_rows('content_blocks') ):
					echo '<div class="content-block">';
						echo '<div class="text-content custom"><div class="container"><h2 style="text-align: center;">From <span style="color: #a2248e;">home</span>, to <span style="color: #4d2b7a;">new home</span>, and <span style="color: #185ba9;">beyond</span></h2></div></div>';
						echo '<div class="two-column custom">';
							echo '<div class="container">';
								echo '<div class="uk-grid-large uk-child-width-1-1@s uk-child-width-1-3@m uk-grid-match uk-grid" uk-grid="">';
									echo '<div class="uk-width-expand uk-first-column">';
										echo '<div class="border">';
											echo '<img src="'.get_stylesheet_directory_uri().'/img/before_you_move.jpg">';
											echo '<h3>Before you move</h3>';
											echo '<ul class="cross">';
												echo '<li><span>Pre-move consultation</span></li>';
												echo '<li><span> Home survey</span></li>';
												echo '<li><span>Visa and immigration support</span></li>';
												echo '<li><span>Home search</span></li>';
												echo '<li><span>School search</span></li>';
												echo '<li><span>Departure support</span></li>';
												echo '<li><span>Packing</span></li>';
											echo '</ul>';
										echo'</div>';
									echo '</div>';
									echo'<div class="uk-width-expand">';
										echo'<div class="border">';
											echo '<img src="'.get_stylesheet_directory_uri().'/img/moving_process.jpg">';
											echo'<h3>During the moving process</h3>';
											echo'<ul class="cross">';
												echo'<li><span>Transportation</span></li>';
												echo'<li><span>Shipment protection</span></li>';
												echo'<li><span>Delivery</span></li>';
												echo'<li><span>Unpacking</span></li>';
												echo '<li><span>Handyman service</span></li>';
											echo'</ul>';
										echo'</div>';
									echo'</div>';
									echo '<div class="uk-width-expand">';
										echo '<div class="border">';
											echo '<img src="'.get_stylesheet_directory_uri().'/img/help_you_settle.jpg">';
											echo '<h3>To help you settle in</h3>';
											echo '<ul class="cross">';
												echo'<li><span>Secure storage</span></li>';
												echo'<li><span>Settling-in services</span></li>';
												echo'<li><span>Language training</span></li>';
												echo'<li><span>Cultural training</span></li>';
											echo'</ul>';
										echo'</div>';
									echo'</div>';
								echo'</div>';
					        			...
					        			if ( get_sub_field('icon_item') ):
					        				echo '<div uk-grid uk-height-match="target: > div > .bordered p.description">';
							        			...
							        			foreach ( get_sub_field('icon_item') as $item ):
							        				echo '<div class="'.( $many > 4 ? 'uk-width-1-2@s uk-width-1-3@m': 'uk-width-expand').'">';
								        					if ( $item['color'] ):
						    ...
						    elseif( get_row_layout() == 'two_column' ):
						    	if ( get_sub_field('column') ):
							    	echo '<div class="two-column">';
							        	echo '<div class="container">';
								        	echo '<div class="uk-grid-large uk-child-width-1-1@s uk-child-width-1-3@m uk-grid-match" uk-grid>';
				...
				if ( is_singular( 'uk-content' ) ):
					$clone_listing = get_field('local_guide_listings', 'option' );
					$listing = $clone_listing['guide_listings'];
					echo '<div class="content-block">';
						echo'<div id="london_office">';
							echo '<div class="container">'; 
								if( $listing['title'] ):
