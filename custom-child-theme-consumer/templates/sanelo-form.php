		...
		echo '<div class="container-fluid default-container">';
			echo '<div class="row">';
				...
				if(get_field('banner')):?>
					...
					<div id="main-banner" class="container-fluid default-container banner uk-background-cover sanelo-popup-form-banner" <?= $banner['banner_image']?'style="background-image:url('.$banner['banner_image']['url'].')"':'';?> data-mobile = <?=$banner['banner_image_mobile']['url'] ;?>>	
					
						<div class="row">
							<div class="container uk-flex uk-flex-center uk-flex-middle" >
								<div class="banner-container sanelo-popup-form">
									<?php if ($banner):
