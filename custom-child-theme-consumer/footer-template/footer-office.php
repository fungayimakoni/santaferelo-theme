...
<footer class="footer">
  <div class="container">
    <div class="footer-menu" >
      <?php if( get_field('social_media', 'option') || has_nav_menu( 'footer-menu-1' ) ):?>
        <div class="item">
          <?php if ( has_nav_menu( 'footer-menu-1' ) ):
            ...
            <?php if( get_field('social_media', 'option') ):?>
								<div class="social-media">
										<ul class="uk-iconnav">
											<?php foreach ( get_field('social_media', 'option') as  $item ):?>
                        ...
                        <?php 
                          ...
                          endswitch;
                        ?>
												  <li><a href="<?=$item['profile_url'];?>"><?= $icon;?></a>
											<?php endforeach;?>
										</ul>
									</div>
						<?php endif;?>
      ...
      <div class="outer-footer">
          ...
          <div class="bottom-bar">
            <?php if (get_field('company_footer', 'option')):?>
              <div class="uk-width-1-3">
                <?=get_field('company_footer', 'option');?>
              </div>
            <?php endif;
...
<script>
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDm9oF3WWbz0PvJoFZMXGs3KDJBo_Eb6zw&callback=initMap">
    </script>
    <script>
      var _hmt = _hmt || [];
      (function() {
